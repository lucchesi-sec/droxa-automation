...
export function Footer() {
	return (
		<footer className="md:rounded-t-6xl relative w-full max-w-6xl mx-auto flex flex-col items-center justify-center rounded-t-4xl border-t bg-[radial-gradient(35%_128px_at_50%_0%,theme(backgroundColor.white/8%),transparent)] px-6 py-12 lg:py-16 mt-24 z-10">
			...
			<div className="grid w-full gap-8 xl:grid-cols-2 xl:gap-8">
				<AnimatedContainer className="space-y-4">
					...
					<p className="text-muted-foreground mt-8 text-sm md:mt-4 max-w-sm">
				...
				<AnimatedContainer className="mt-10 xl:mt-0">
					<div className="flex justify-end">
						<div className="grid grid-cols-2 gap-8 md:grid-cols-3 max-w-md">
